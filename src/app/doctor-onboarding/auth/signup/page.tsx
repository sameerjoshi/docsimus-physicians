...
export default function SignupPage() {
  ...
  const { updateAuth } = useDoctorOnboarding();
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    router.push("/doctor-onboarding/auth/verify-email");
  };
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="text-sm text-center text-muted-foreground">
                Already registered? <Link href="/doctor-onboarding/auth/login" className="text-primary font-medium hover:underline">Login</Link>
              </div>
            </form>
          </CardContent>
        </Card>
