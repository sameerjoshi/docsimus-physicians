...
export default function OnboardingHubPage() {
  ...
  useEffect(() => {
    ...
    if (state.status === "pending" || state.status === "submitted") {
      router.push("/doctor-onboarding-new/review");
    }
  ...
  const sections: Section[] = [
    {
      ...
      href: "/doctor-onboarding-new/personal",
    ...
    },
    {
      ...
      href: "/doctor-onboarding-new/address",
    ...
    },
    {
      ...
      href: "/doctor-onboarding-new/medical",
    ...
    },
    {
      ...
      href: "/doctor-onboarding-new/documents",
    ...
    },
    {
      ...
      href: "/doctor-onboarding-new/availability",
  ...
  return (
    <div className="min-h-screen bg-secondary/60 px-4 py-12">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        >
          {totalCompleted === 5 ? (
            <Link href="/doctor-onboarding-new/review">
